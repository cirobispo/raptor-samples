...
function Widget() {
    var chooseLocation = this.widgets.chooseLocation;
    var _this = this;
...
Widget.prototype = {
    hideWeather: function() {
        ...
        this.widgets.chooseLocation.setLocation('');
    },
    ...
    showWeatherForLocation: function(location, updateHistory) {
        ...
        this.widgets.chooseLocation.setLocation(location.query);
        ...
        weatherService.getCurrentWeather(location, function(err, data) {
            ...
            locationWeather.render({
                ...
                function(err, renderResult) {
                    renderResult.replaceChildrenOf(targetEl);
                });
